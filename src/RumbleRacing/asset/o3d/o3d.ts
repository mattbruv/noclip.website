...
// Bounding volumes stored in the tail of a Gmd chunk. The engine copies the
// sphere into the actor at init time; SFX_RenderPowerup sizes the power-up glow
// primitives from its radius.
